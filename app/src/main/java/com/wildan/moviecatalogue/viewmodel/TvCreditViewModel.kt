...
class TvCreditViewModel : ViewModel(), CreditView.ViewModel, RecommendedView.ViewModel {

    private val listCasts = MutableLiveData<ArrayList<CastData>>()
    private val listCrews = MutableLiveData<ArrayList<CrewData>>()
    private val listRecommend = MutableLiveData<ArrayList<TvShowResult>>()
    ...
    fun getListRecommend(): LiveData<ArrayList<TvShowResult>> {
    ...
    override fun setRecommended(page: Int, apiKey: String, movieId: String, view: RecommendedView.View) {
        ...
        Rx2AndroidNetworking.get(BASE_URL + "tv/{tv_id}/recommendations")
            ...
            .subscribe(object : Observer<TvShowResponse> {
                ...
                override fun onNext(t: TvShowResponse) {
                    listRecommend.postValue(t.tvResult)
                }
    ...
    override fun setCreditData(apiKey: String, movieId: String, view: CreditView.View) {
        ...
        Rx2AndroidNetworking.get(BASE_URL + "tv/{tv_id}/credits")
            .addQueryParameter("api_key", apiKey)
            .addPathParameter("tv_id", movieId)
            .build()
